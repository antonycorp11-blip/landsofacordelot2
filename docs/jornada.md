...
2. Aceite um dos quatro contratos. Todos concedem ouro, influência, comida e XP, além de habilidade, carreira e relações. Qualquer personagem pode seguir qualquer carreira. No contrato comercial, compre a encomenda indicada no mercado de origem antes de partir.
...
4. Decida com a viagem pausada. Cada escolha apresenta custo, atributo, habilidade, chance e ganhos em caso de sucesso ou falha. O dado da cena é persistido para impedir uma nova tentativa ao reabrir. Resultados que sobem de nível informam os pontos para distribuir.
...
- Ouro, comida e influência são recursos persistidos. Provisões são compradas no mercado e consumidas diariamente; tropas recebem salário diário. Falta de pagamento ou alimento reduz o grupo e pode provocar deserção.
- Mercados possuem estoque, reposição, preço regional e oito cargas comerciais além de provisões. Capacidade de carga, custo médio e lucro persistem. Veja [Economia](economia.md).
- O combate contra bandos e emboscadas acontece em rodadas. Avançar, segurar, flanquear e recuar mudam ataque, exposição, baixas e moral; perdas permanecem na campanha.
